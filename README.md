...
If you want to use this code, contribute to it, ask questions or propose ideas, please consider joining [our discourse channel](https://forum.thousandbrains/).

[![](docs/figures/overview/discourse_screenshot.png)](https://forum.thousandbrains/)
