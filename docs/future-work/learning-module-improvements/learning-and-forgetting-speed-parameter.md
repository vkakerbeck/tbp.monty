...
The idea here is to leverage the existing [constrained object models](../../how-monty-works/learning-module/object-models.md#object-models) and add a learning speed parameter into it. The concrete way of how this parameter could work would need to be outlined in an [RFC](../../contributing/request-for-comments-rfc.md). Ideally, it should also incorporate forgetting.