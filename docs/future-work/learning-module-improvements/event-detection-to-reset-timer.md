...
This item relates to the broader goal of [modeling object behaviors in Monty](../../theory/object-behaviors.md#implementation-in-monty). For a broader overview of the (semi)-global interval timer, see [this future work page](../cmp-hierarchy-improvements/global-interval-timer.md).
