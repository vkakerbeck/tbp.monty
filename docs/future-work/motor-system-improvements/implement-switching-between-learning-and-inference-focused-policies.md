...
> [!NOTE]
> Currently we have policies in several different places (SM goal generator, LM goal generator, goal selector, motor system) and this item here might relate more to LM goal generator improvements as opposed to the motor system. This item needs to be scoped more and might be moved in category.
...
This would be a specific example of a more general mechanism for switching between different policies, as discussed in [Switching Policies via Goals](interpret-goal-states-in-motor-system-switch-policies.md).
