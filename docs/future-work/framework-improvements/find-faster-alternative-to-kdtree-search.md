...
Collin did a comparison of different methods in May 2025 and found that our current method was the best for our usecase at the moment. For the full results, see [this thread](https://thousandbrains.discourse.group/t/gpu-acceleration-of-knn-search-update/620). However, there may be other nearest neighbor algorithms that were not tested there and that would do better in our scenaro (finding nearest neighbors in 3D space).
