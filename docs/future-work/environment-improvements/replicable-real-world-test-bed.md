...
It would be great to have a robotic setup that can easily be replicated by anyone. This means, all parts should be listed and obtainable, ideally at low cost. There should also be exactly specified experimental setups and evaluation pipelines (similar to our [benchmarks in simulation](../../overview/benchmark-experiments.md)).
