...
>
> If you run into problems, please let us know by [opening a GitHub issue](https://github.com/thousandbrainsproject/tbp.monty/issues/new/choose) or [posting in the Monty Code section of our forum](https://forum.thousandbrains/c/monty-code/6).
...
If you run into any issues or questions, please head over to our [Discourse forum](https://forum.thousandbrains/) or [open an Issue](../contributing/contributing.md#report-an-issue). We are always happy to help!
